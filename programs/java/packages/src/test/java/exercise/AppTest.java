...
class AppTest {
    ...
    // BEGIN
    @Test
    void isBelongToOneQuadrant() {
        var segment1 = Segment.makeSegment(Point.makePoint(1, 4), Point.makePoint(5, 8));
        assertThat(App.isBelongToOneQuadrant(segment1)).isTrue();

        var segment2 = Segment.makeSegment(Point.makePoint(1, 4), Point.makePoint(0, 0));
        assertThat(App.isBelongToOneQuadrant(segment2)).isFalse();

        var segment3 = Segment.makeSegment(Point.makePoint(-1, 4), Point.makePoint(1, -4));
