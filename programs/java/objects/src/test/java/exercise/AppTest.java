...
class AppTest {
    ...
    // BEGIN
    @Test
    void getYoungestUser() throws Exception {
        String[][] users2 = {
                {"Andrey Petrov", "1990-11-23"},
        ...
        String actual1 = App.getYoungestUser(users2, "21 Nov 1983");
        assertThat(actual1).isEqualTo("");

        String actual2 = App.getYoungestUser(users2, "11 Jul 1989");
        assertThat(actual2).isEqualTo("John Smith");

        String actual3 = App.getYoungestUser(users2, "16 Oct 2021");
        assertThat(actual3).isEqualTo("Aleksey Ivanov");
    }
    // END
}
