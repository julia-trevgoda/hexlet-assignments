...
class ValidationTest {
    ...
    // BEGIN
    @Test
    void testAdvancedValidate() throws IllegalAccessException, NoSuchFieldException {
    ...
    @Test
    void testAdvancedValidate2() throws IllegalAccessException, NoSuchFieldException {
